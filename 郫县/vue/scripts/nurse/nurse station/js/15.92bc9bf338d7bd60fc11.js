...
var actions = {
  ...
  getOrders: function getOrders(_ref25) {
    ...
    var _state$searchInfo = state.searchInfo,
        ...
        longOrderNotNewFlag = _state$searchInfo.longOrderNotNewFlag,
    ...
    _nurseExcute2.default.getOrders(state.selectedPatients.join('^'), sheetCode, hospitalID, groupID, startDate, startTime, endDate, endTime, wardID, locID, doctorOrderFlag, createOrderFlag, excutedOrderFlag, orderType, printedOrderFlag, longOrderFlag, longOrderNotNewFlag, tempOrderFlag).then(function (data) {
      commit({
...
//# sourceMappingURL=15.92bc9bf338d7bd60fc11.js.map