  ...
  <div class="orderExcute">
    <!-- <ul class="orderExcute__searchUl">
      ...
      <li class="orderExcute__searchLi">
        <div class="orderExcute__checkBox">
          <el-checkbox :value="searchInfo.longOrderFlag"
                       @input="onLongOrderFlagChange">长期</el-checkbox>
        </div>
        <div class="orderExcute__checkBox">
          <el-checkbox :value="searchInfo.tempOrderFlag"
                       @input="onTempOrderFlagChange">临时</el-checkbox>
        </div>
      </li>
      <li class="orderExcute__searchLi"
          style="align:left">
      ...
      <li class="orderExcute__searchLi">
        <common-button class="orderExcute__searchBtn"
                       ...
                       color="#ffffff"
                       border="#509de1"
                       background-color="#509de1">查询</common-button>
      </li>
    </ul> -->
    <!-- <ul class="orderExcute__disposeStat ">
      <li>
        ...
        <el-tag type="info"
                size="mini"
                class="orderExcute__disposeStat--NeedToStop">停止需处理</el-tag>
        <el-tag type="info"
                size="mini"
                class="orderExcute__disposeStat--AlreadyStop">停止已处理</el-tag>
        <el-tag type="info"
                size="mini"
      ...
      <div class="orderExcute__tabContent"
        ...
        <div class="orderExcute__btns">
          ...
          <template v-for="(button,index) of buttons">
            ...
            <span class="orderExcute__unPrintNum"
          ...
          <el-select size="mini"
                     ...
                     clearable
                     placeholder="默认用药途径">
            <el-option v-for="item in filerColumnsSort"
                       :key="item.key"
                       :label="item.title"
          ...
          <el-input class="orderExcute__printCountInput"
          ...
          <el-select size="mini"
                     ...
                     filterable
                     clearable>
            <el-option v-for="item in disposeStats"
                       :key="item.code"
                       :label="item.desc"
...
import OrderSearch from "../orderExcute/OrderSearch";
import OrderSetPlacerNotes from "../orderExcute/OrderSetPlacerNotes";
import OrderSign from "../orderExcute/OrderSign";
...
export default {
  ...
  mounted() {
    this.$eventBus.$on("appPatTree-patients-change", () => {
      this.requestQuery();
    });
  },
  watch: {
  ...
  methods: {
    ...
    onPrintHistoryBtnClick() {
      ...
      window.open(
        ...
        "护士打印日志",
        `top=0,left=0,width=${window.screen.availWidth - 100},height=${window
          .screen.availHeight - 100},toolbar=no, menubar=no`
      );
    }
  }
};
