<template>
  <div class="TemperatureBabyMeasureSingle">
    <PatientTree class="TemperatureBabyMeasureSingle__patientTree"
                 :wardID="wardID"
                 @currentChange="currentChange"
                 :episodeID="currentPatient.episodeID"
                 select></PatientTree>
    <MeasureSingle class="TemperatureBabyMeasureSingle__measureSingle"
...
@b TemperatureBabyMeasureSingle {
  width: 85%;
  height: 80%;
  position: absolute;
  top: 50%;
